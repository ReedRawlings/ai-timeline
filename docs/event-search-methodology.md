...
### 2026-07-05 — Added the labs' own research feeds; "under-mining a source counts as skipping it"
The May pass missed OpenAI's May 20 disproof of an ~80-year-old Erdős conjecture in discrete geometry — the first time a prominent open problem central to a subfield of mathematics was solved autonomously by AI (Fields medalist Tim Gowers: "a milestone in AI mathematics"). The instructive part: this was *not* a case of the curated sources lacking research coverage — Superintelligence had covered it. The failure was reading only Superintelligence's homepage (recent days) rather than its month archive, then reporting the source as "checked." Two fixes: (1) the review's "which sources did you hit" gate now means *hit for the target month*, and the Superintelligence entry points at the month archive, not the homepage; (2) added the labs' own research/news feeds — OpenAI (`/news/research`), Anthropic (`/research`), Google DeepMind (`/research`) — as primary publishers to scan, since labs headline their own novel work and these surface the research/science milestones the general-interest editors under-cover. This is "read the primary publisher directly," not "run more generic sweeps."
