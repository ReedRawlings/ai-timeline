...
- **Added 2026-07-07 from the FEDS note's references (both pending direct verification):** Crane, Green & Soto (2025), "Measuring AI Uptake in the Workplace" (FEDS Notes, doi 10.17016/2380-7172.3724) — compared 16 AI-adoption surveys, 5–40% spread as of mid-2024; prior art for the panel's premise and a trailhead to uncataloged surveys. Hartley, Jolevski, Melo & Moore (2026), "The Labor Market Effects of Generative Artificial Intelligence" (SSRN 5136877) — per Allen (2026): nationally representative, Dec 2025 wave, 33% of genAI-using workers use it daily; recurrence unverified. **Also from the note itself:** RPS Nov 2025 wave anchors reported secondhand (work use 40.7%, +9.7 YoY; daily-last-week 12%; ≥once-last-week 35.2%; nonwork ≈50%) — recorded here pending primary confirmation from the tracker/authors, not ingested as estimate rows (publisher-primary rule).
