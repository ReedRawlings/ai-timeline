...
- **Verbatim stem: UNPUBLISHED — gap confirmed real (2026-07-07 dedicated search).** Checked: Indicator page (gallup.com/699797), articles 691643 / 699689 / 701195 / 704225, the linked "Workplace Q4 Topline AI Trends" PDF (https://www.gallup.com/file/workplace/701867/Workplace%20Q4%20Topline%20AI%20Trends.pdf — data pages are image-based, text-unextractable; **best remaining lead**, needs OCR/browser), Bentley–Gallup 2025 report (no usage-frequency item at all), Gallup methodology center, Roper Center iPoll (JS-gated, indeterminate — not a clean negative). Every Gallup article paraphrases, never block-quotes, the item.
...
- **Still unobtainable without a JS browser/OCR:** the literal Appendix A instrument layout/skip logic of CES-WP-26-25; the data_downloads file manifest (census.gov/hfp/btos/data_downloads is JS-gated); a clean supplement-2 response rate; Federal Register notice for OMB 0607-1022 (not attempted — next lead).
